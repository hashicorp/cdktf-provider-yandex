// https://www.terraform.io/docs/providers/yandex/r/resourcemanager_cloud
...
export function resourcemanagerCloudTimeoutsToTerraform(struct?: ResourcemanagerCloudTimeoutsOutputReference | ResourcemanagerCloudTimeouts | cdktf.IResolvable): any {
...
export class ResourcemanagerCloudTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ResourcemanagerCloudTimeouts | undefined {
  ...
  public set internalValue(value: ResourcemanagerCloudTimeouts | undefined) {
    if (value === undefined) {
