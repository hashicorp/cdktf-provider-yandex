// https://www.terraform.io/docs/providers/yandex/d/dns_zone
...
export function dataYandexDnsZoneTimeoutsToTerraform(struct?: DataYandexDnsZoneTimeoutsOutputReference | DataYandexDnsZoneTimeouts | cdktf.IResolvable): any {
...
export class DataYandexDnsZoneTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataYandexDnsZoneTimeouts | undefined {
  ...
  public set internalValue(value: DataYandexDnsZoneTimeouts | undefined) {
    if (value === undefined) {
