...
export class MdbMongodbClusterTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): MdbMongodbClusterTimeouts | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: MdbMongodbClusterTimeouts | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class MdbMongodbCluster extends cdktf.TerraformResource {
  ...
  */
  ...
  private _database?: MdbMongodbClusterDatabase[] | cdktf.IResolvable; 
  public get database() {
    // Getting the computed value is not yet implemented
    return cdktf.Token.asAny(cdktf.Fn.tolist(this.interpolationForAttribute('database')));
  }
  public set database(value: MdbMongodbClusterDatabase[] | cdktf.IResolvable) {
  ...
  private _host?: MdbMongodbClusterHost[] | cdktf.IResolvable; 
  public get host() {
    // Getting the computed value is not yet implemented
    return this.interpolationForAttribute('host');
  }
  public set host(value: MdbMongodbClusterHost[] | cdktf.IResolvable) {
    this._host = value;
  }
  // Temporarily expose input value. Use with caution.
  ...
  private _user?: MdbMongodbClusterUser[] | cdktf.IResolvable; 
  public get user() {
    // Getting the computed value is not yet implemented
    return cdktf.Token.asAny(cdktf.Fn.tolist(this.interpolationForAttribute('user')));
  }
  public set user(value: MdbMongodbClusterUser[] | cdktf.IResolvable) {
    this._user = value;
  }
  // Temporarily expose input value. Use with caution.
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      database: cdktf.listMapper(mdbMongodbClusterDatabaseToTerraform)(this._database),
      host: cdktf.listMapper(mdbMongodbClusterHostToTerraform)(this._host),
      ...
      user: cdktf.listMapper(mdbMongodbClusterUserToTerraform)(this._user),
    };
  }
}
