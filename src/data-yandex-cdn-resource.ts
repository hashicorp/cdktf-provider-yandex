// https://www.terraform.io/docs/providers/yandex/d/cdn_resource
...
export function dataYandexCdnResourceSslCertificateToTerraform(struct?: DataYandexCdnResourceSslCertificateOutputReference | DataYandexCdnResourceSslCertificate): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataYandexCdnResource extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _sslCertificate = new DataYandexCdnResourceSslCertificateOutputReference(this, "ssl_certificate");
  public get sslCertificate() {
    return this._sslCertificate;
  }
  public putSslCertificate(value: DataYandexCdnResourceSslCertificate) {
