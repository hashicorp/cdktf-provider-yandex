// https://www.terraform.io/docs/providers/yandex/r/api_gateway
...
export function apiGatewayTimeoutsToTerraform(struct?: ApiGatewayTimeoutsOutputReference | ApiGatewayTimeouts | cdktf.IResolvable): any {
...
export class ApiGatewayTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ApiGatewayTimeouts | undefined {
  ...
  public set internalValue(value: ApiGatewayTimeouts | undefined) {
    if (value === undefined) {
